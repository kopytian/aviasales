...
class Locations{ 
    ...
    getAirlineNameByCode(code) { 
        return this.airlines[code].name || this.airlines[code].name_translations.en;
    } 

    getAirlineLogoByCode(code) { 
        return this.airlines[code].logo || this.airlines[code].name || this.airlines[code].name_translations.en;
    } 
